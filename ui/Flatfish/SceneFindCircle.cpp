...
void CSceneFindCircle::UpdateUI(int iSceneID, int index,CWnd *hROI)
{
    ...
    if (iPos >= 0)
    {
        ...
        sprintf(szBuf, "%0.0f", config.vecBody[iPos][RING_WIDTH_INDEX].dValue);
